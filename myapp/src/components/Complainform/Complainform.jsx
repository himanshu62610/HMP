        ...
        <div>
            ...
            <div className='container' id="form_details">
                ...
                <div id='content' >
                    ...
                    <div className="mb-3">
                        <label for="exampleFormControlInput2" className="form-label">Title :-{" "}</label>
                        <input type="text" className="form-control" id="exampleFormControlInput2" placeholder="title" value={credentials.title} name='title'onChange={Onchange}/>
                    </div>
